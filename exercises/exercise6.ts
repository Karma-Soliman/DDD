...
export function exercise6_TemporalLogic() {
	...
	const restaurant: Restaurant = {
		name: "Joe's Diner",
		operatingHours: OperatingHours.create(6,22)
	}
...
//		return hour >= restaurant.opensAt && hour <= restaurant.closesAt
	...
	logError(6, "Operating hours logic broken for overnight restaurants", {
		...
		isOpenCalculated: restaurant.operatingHours.isOpenAt(2), // Returns false incorrectly
	...
	const brokenRestaurant: Restaurant = {
		name: "Broken Cafe",
		operatingHours: OperatingHours.create(23,5)
	}
